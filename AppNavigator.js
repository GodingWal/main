...
import ForgotPasswordScreen_7n1gOTFM from './screens/ForgotPasswordScreen_7n1gOTFM';
...
import StatisticsScreen_bua3YuzZ from './screens/StatisticsScreen_bua3YuzZ';
...
function BottomTabNavigator() {
  return (
    <Tab.Navigator
      tabBarOptions={{
        activeTintColor: theme.colors['GetFit Orange'],
        style: {
    ...
    >
      ...
      />
      <Tab.Screen
        name="StatisticsScreen_bua3YuzZ"
        component={StatisticsScreen_bua3YuzZ}
        options={{
          title: 'Statistics',
          tabBarIcon: ({ focused, color }) => (
            <Icon
  ...
  return (
    <NavigationContainer linking={LinkingConfiguration}>
      <Stack.Navigator
        ...
        screenOptions={{
          cardStyle: {
            backgroundColor: theme.colors['Custom #00374b'],
          },
        }}
      >
        <Stack.Screen
        ...
        <Stack.Screen
          ...
          options={{ title: 'Onboarding Enter App' }}
        />
        <Stack.Screen
        ...
        <Stack.Screen
          ...
          options={{ title: 'Onboarding 2.2' }}
        />
        <Stack.Screen
          name="Onboarding23Screen"
          component={Onboarding23Screen}
          options={{ title: 'Onboarding 2.3' }}
        />
        <Stack.Screen
        ...
        <Stack.Screen
          ...
          options={{ title: 'Create Account Form' }}
        />
        <Stack.Screen
          name="ForgotPasswordScreen_7n1gOTFM"
          component={ForgotPasswordScreen_7n1gOTFM}
          options={{ title: 'Forgot Password' }}
        />
        <Stack.Screen
          name="CreateaNewPasswordScreen"
          component={CreateaNewPasswordScreen}
          options={{ title: 'Create a New Password' }}
        />
        <Stack.Screen
          name="EnterOTPScreen"
        ...
        <Stack.Screen
          ...
          options={{ title: 'Make Todays Plane' }}
        />
        <Stack.Screen
          name="PlaneDetailsScreen"
          component={PlaneDetailsScreen}
          options={{ title: 'Plane Details' }}
        />
        <Stack.Screen
          name="LoginEmailScreen"
          component={LoginEmailScreen}
          options={{ title: 'Login Email' }}
        />
        <Stack.Screen
          name="FiltersScreen"
